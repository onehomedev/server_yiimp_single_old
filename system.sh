...
###########################################
# Created by One Home for YiiMP use... #
###########################################
...
echo -e " Downloading One Home YiiMP Repo...$COL_RESET"
...
cd $STORAGE_ROOT/yiimp/yiimp_setup/yiimp
hide_output sudo git clone https://github.com/onehomedev/stratum-lowdiff.git
sleep 2s

echo -e " Downloading Full Stratum...$COL_RESET"
cd $STORAGE_ROOT/yiimp/yiimp_setup/yiimp
hide_output sudo git clone https://github.com/onehomedev/stratum-full.git
sleep 2s

echo -e " Downloading Zentoshi Stratum...$COL_RESET"
cd $STORAGE_ROOT/yiimp/yiimp_setup/yiimp
hide_output sudo git clone https://github.com/onehomedev/stratum-zenx.git
sleep 2s
